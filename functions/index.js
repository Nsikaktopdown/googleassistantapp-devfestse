...
exports.conversationComponent = functions.https.onRequest((req, res) => {
  ...
  function welcome (app) {
    app.ask(app.buildRichResponse()
      ...
      .addSimpleResponse({
        speech: 'Welcome to devfestse Aba, the bigggest developers event in South-South and South-East Nigeria',
        displayText: 'Welcome to devfestse Aba, the bigggest developers event in South-South and South-East Nigeria ' +
          'well as suggestions'})
      .addSuggestions(
        ['Sessions', 'Speakers', 'Codelabs', 'List']));
  }
